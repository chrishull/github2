...
SHIFT1		res	1
SHIFT2		res	1
SHIFT3		res	1		; not used in 48 bit systems
...
SHIFTG3		res	1	; not used in 48 bit systems
SHIFTY3		res	1	; not used in 48 bit systems
SHIFTR3		res	1	; not used in 48 bit systems
...
SHIFT_5		res	1
SHIFT_6		res	1
SHIFT_7		res	1		; Not used with 48 LED configuration
SHIFT_8		res	1		; Not used with 48 LED configuration
SHIFT_9		res	1		; Not used with 48 LED configuration

; 72 bit color matched shift, are preserved by shift routines
SHIFT_G1	res	1
SHIFT_G2	res	1
SHIFT_G3	res	1		; Not used with 48 LED configuration

SHIFT_Y1	res	1
SHIFT_Y2	res	1
SHIFT_Y3	res	1		; Not used with 48 LED configuration

SHIFT_R1	res	1
SHIFT_R2	res	1
SHIFT_R3	res	1		; Not used with 48 LED configuration
...
S8_LOOP
	; Set IO_REG according to the high bit
	BTFSC	SHIFT1, 7
	GOTO	S8_SKIP
	BCF	IO_REG, SHIFT1_DAT1
	GOTO	S8_CLOCK
S8_SKIP
	BSF	IO_REG, SHIFT1_DAT1

S8_CLOCK
	BSF	IO_REG, SHIFT1_CLK	;Clock GND
	BCF	IO_REG, SHIFT1_CLK	;Clock PULLUP
	RLF	SHIFT1, F
...
ST_LOOP1
	BSF	IO_REG, SHIFT1_DAT1	;Set the bit
	CALL	DELAY
	BSF	IO_REG, SHIFT1_CLK	;Clock GND
	CALL	DELAY
	BCF	IO_REG, SHIFT1_CLK	;Clock PULLUP
...
ST_LOOP2
	BCF	IO_REG, SHIFT1_DAT1	;Clear the bit
	CALL	DELAY
	BSF	IO_REG, SHIFT1_CLK	;Clock GND
	CALL	DELAY
	BCF	IO_REG, SHIFT1_CLK	;Clock PULLUP
